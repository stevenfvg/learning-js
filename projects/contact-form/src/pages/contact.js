                ...
                <div class="offset-xl-1 col-xl-5 col-lg-6 col-md-12 col-12">
                    <div class="py-8 me-xl-8 pe-xl-8">
                        ...
                        <div class="d-flex justify-content-between mb-7 align-items-center">
                            <a href="../index.html"><img src="/images/brand/logo/logo.svg" alt="logo" class="logo-inverse" /></a>
                            <!-- Theme Switch -->
                        ...
                        <div>
                            ...
                            <div class="mt-8 fs-4">
                                <p class="mb-4">
                                    ...
                                    <a href="#" class="disabled">support portal</a>
                        ...
                        <div>
                            ...
                            <form class="row needs-validation" novalidate>
                                ...
                                <div class="mb-3 col-12">
                                    <label class="text-dark form-label" for="email">
                                        Email:
