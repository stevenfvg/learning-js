        ...
        <footer class="pt-lg-10 pt-5 footer bg-white">
            <div class="container">
                <div class="row">
                    ...
                    <!-- about company -->
                        <div class="mb-4">
                            <img src="../public/dist/assets/images/brand/logo/logo.svg" alt="logo" class="logo-inverse ">
                            <div class="mt-4">
                    ...
                    <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                                <li><a href="" class="nav-link disabled">About</a></li>
                                <li><a href="" class="nav-link disabled">Pricing</a></li>
                                <li><a href="" class="nav-link disabled">Blog</a></li>
                                <li><a href="" class="nav-link disabled">Careers</a></li>
                                <li><a href="" class="nav-link disabled">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6">
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                                <li><a href="" class="nav-link disabled">Help and Support</a></li>
                                <li><a href="" class="nav-link disabled">Become Instructor</a></li>
                                <li><a href="" class="nav-link disabled">Get the app</a></li>
                                <li><a href="" class="nav-link disabled">FAQ’s</a></li>
                                <li><a href="" class="nav-link disabled">Tutorial</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex">
                                ...
                                <!-- <a href="" class="ms-2"><img src="../public/dist/assets/images/svg/playstore.svg" alt="" class="img-fluid"></a> -->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-lg-flex align-items-center">
                            ...
                            <div>
                                <nav class="nav nav-footer">
                                    <a class="nav-link ps-0 disabled" href="">Privacy Policy</a>
                                    <a class="nav-link px-2 px-md-3 disabled" href="">Cookie Notice </a>
                                    <a class="nav-link d-none d-lg-block disabled" href="">Do Not Sell My Personal Information </a>
